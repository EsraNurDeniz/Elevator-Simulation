...
always_comb
 begin 
  ...
  case(digit_val)
   ...
   4'd10: sseg_LEDs = 7'b1011111; //to display a
   4'd11: sseg_LEDs = 7'b1101111; //to display b
   4'd12: sseg_LEDs = 7'b1110111; //to display c
   4'd13: sseg_LEDs = 7'b1111011; //to display d
   4'd14: sseg_LEDs = 7'b1101101; //to display e
   4'd15: sseg_LEDs = 7'b1111110; //to display f   
